#In this version we automatically adjust the mean and standard deviation by 0.5
#We also only return the logits 
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        #Mean and variance pre-adjusted 
        self.matrixMean = torch.ones(3, img_size, img_size)
        self.matrixMean = self.matrixMean*0.5
        self.matrixStd = torch.ones(3, img_size, img_size)
        self.matrixStd = self.matrixStd*0.5
